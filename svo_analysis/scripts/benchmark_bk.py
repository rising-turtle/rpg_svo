...
def run_experiment(dataset, params):
    ...
    # print('algo_params_file= {}'.format(algo_params_file))
    ...
    if 'rig_size' not in dataset_params or dataset_params['rig_size'] == 1:
        ...
        # print('rig_size dataset_params[rig_size] = {}'.format(dataset_params['rig_size']))
        # print_dict(params)
    else:
    ...
    if params['dataset_is_blender']:
        # print('dataset_is_blender, copy trajectory_norminal.txt')
    ...
    # execute ros node
    print('args.version = {} args.executable = {}'.format(args.version, args.executable))
    print_dict(params)
...
if __name__=="__main__":
    ...
    # print('args.experiment_file = {}'.format(args.experiment_file))

    experiment_params_file = os.path.join(rospkg.RosPack().get_path('svo_analysis'), 
                               'experiments', args.experiment_file+'.yaml')
    # print('experiment_params_file = {}'.format(experiment_params_file))
    if os.path.exists(experiment_params_file):
        # print('experiment file = {}'.format(experiment_params_file))
    ...
    for dataset in experiment_params['datasets']:
        ...
        # print('experiment_name = {}'.format(params['experiment_name']))
        # print('trace_dir = {}'.format(params['trace_dir']))
